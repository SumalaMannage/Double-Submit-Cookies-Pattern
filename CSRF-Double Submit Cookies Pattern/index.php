...
function userLogin()
{
    if (isset($_POST['username'], $_POST['password'])) {
        ...
        if ($_POST['username'] == 'admin' && $_POST['password'] == 'password') {
            ...
            $_SESSION['CSRF_TOKEN']  = sha1(base64_encode(openssl_random_pseudo_bytes(32))); //genarate csrf random token

            setcookie('csrf_token', $_SESSION['CSRF_TOKEN'], time() + 200, '/'); // CSRF cookie with secure flag 
